        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="{{ route('pengaduan.index')}}" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="{{ route('pengaduan.create')}}" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Daftar Pengaduan</a>
                    <a href="table.html" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Data Warga</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
