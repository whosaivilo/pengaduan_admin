...
@section('content')
    ...
    <div class="container-fluid pt-4 px-4">
        <div class="row g-4">
            ...
            </div>{{-- ✅ KARTU BARU: RATA-RATA RATING KINERJA --}}
            <div class="col-sm-6 col-xl-3">
                <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                    <i class="fa fa-star fa-3x text-primary"></i>
                    <div class="ms-3">
                        <p class="mb-2">Rata-rata Rating Kinerja ({{ $total_penilaian }} Penilaian)</p>
                        <h6 class="mb-0">
                            {{-- Tampilkan 2 angka di belakang koma, atau N/A jika tidak ada penilaian --}}
                            @if ($rata_rata_rating > 0)
                                {{ number_format($rata_rata_rating, 2) }} / 5
                            @else
                                N/A
                            @endif
                        </h6>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-info"
                                        href="{{ route('pengaduan.show', $pengaduan->pengaduan_id) }}"><i
                                            class="fa fa-eye"></i></a>
                                </td>
                            </tr>
                        @empty
